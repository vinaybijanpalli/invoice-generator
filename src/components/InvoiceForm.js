...
class InvoiceForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      billToAddress: props.invoice?.billToAddress || "",
      billFrom: props.invoice?.billFrom || "",
      billFromEmail: props.invoice?.billFromEmail || "",
      billFromAddress: props.invoice?.billFromAddress || "",
      notes: props.invoice?.notes || "",
      total: props.invoice?.total || "0.00",
      subTotal: props.invoice?.subTotal || "0.00",
      taxRate: props.invoice?.taxRate || "",
      taxAmmount: props.invoice?.taxAmmount || "0.00",
      discountRate: props.invoice?.discountRate || "",
      discountAmmount: props.invoice?.discountAmmount || "0.00",
    };
    this.state.items = props.invoice?.items || [
      {
        id: 0,
        name: "",
        description: "",
